...
| 步骤 | 操作 | 预期结果 |
|------|------|----------|
| 1 | 完成几个任务，确保「已完成」分组可见 | 已完成分组 header 显示 chevron 箭头（▶ 展开状态为向下旋转） |
| 2 | 点击「已完成 (N)」header | 已完成任务折叠隐藏，chevron 旋转回水平 |
| 3 | 再次点击 header | 已完成任务展开显示，chevron 旋转向下 |
| 4 | 折叠状态下添加新已完成任务（⌘Enter） | header 计数更新，任务仍处于折叠状态 |

### 13.2 状态持久化
| 步骤 | 操作 | 预期结果 |
|------|------|----------|
| 1 | 折叠已完成分组 | - |
| 2 | 完全退出并重新打开应用 | 已完成分组仍处于折叠状态 |
| 3 | 展开已完成分组 | - |
| 4 | 重启应用 | 已完成分组处于展开状态 |
...
| 步骤 | 操作 | 预期结果 |
|------|------|----------|
| 1 | 删除所有已完成任务 | 已完成 section 消失 |
| 2 | 完成一个任务 | 已完成 section 重新出现，折叠状态保持上次设置 |
| 3 | 在搜索/过滤模式下折叠 | 折叠行为正常 |
| 4 | 清除搜索后 | 折叠状态保持 |

---

*测试文档版本: v1.2 | 更新时间: 2026-01-27*
